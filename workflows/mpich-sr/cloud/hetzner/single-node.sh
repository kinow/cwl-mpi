...
# This script sets up a single-node OpenMPI installation to
# test the Simple MPI program. It has been successfully
# tested on a 2vCPU Intel/AMD x86 instance on Hetzner.

USERNAME=cwlmpi
MAMBA_BIN="/usr/local/bin/micromamba"

echo "[0/8] System packages + MPI + containers"
apt update
